...
def after_load_location_file(location_table: list) -> list:
    ...
    extra_location_files = ["data/locations/locations_dens.json", "data/locations/locations_trees.json", "data/locations/locations_wanderers.json", "data/locations/locations_routes.json", "data/locations/locations_items.json", "data/locations/locations_story.json", "data/locations/locations_trainers.json"]
